...
int PQCLEAN_MLDSA44_CLEAN_crypto_sign_keypair(uint8_t *pk, uint8_t *sk)
{
    ...
    timer.offTimer(6);
    timer.setTimerName(6, "Power2Round");
                                                    ...
                                                    const uint8_t *sk)
{
    ...
    timer.offTimer(0);
    timer.setTimerName(0, "Compute mu");
    ...
    timer.offTimer(1);
    timer.setTimerName(1, "Compute rho'' ");
    ...
    timer.offTimer(11);
    timer.setTimerName(11, "NTT s1, s2, t0");
...
rej:
    ...
    timer.offTimer(3);
    timer.setTimerName(3, "ExpandMask");
    ...
    timer.offTimer(13);
    timer.setTimerName(13, "INVNTT A * y");
    ...
    timer.offTimer(5);
    timer.setTimerName(5, "Highbits w1");
    ...
    timer.offTimer(8);
    timer.setTimerName(8, "c * s1, c*s2");
    ...
    timer.offTimer(15);
    timer.setTimerName(15, "INTT c * s1, c*s2");
    ...
    timer.offTimer(16);
    timer.setTimerName(16, "INTT ct0");
    ...
    timer.offTimer(10);
    timer.setTimerName(10, "Make Hint");
